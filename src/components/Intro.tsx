...
const FeaturedAuthor = () => {
  ...
  <div className="grid grid-cols-2 justify-center items-center bg-gray-600 p-4 md:p-8 rounded-2xl">
    <div>
    ...
    <div className=" p-2 md:p-0 ">
      ...
      />
      <h1 className="text-md md:text-2xl my-2 font-semibold ">Featured Author</h1>
  ...
  <div className=''>
      <h1 className='text-xl md:text-4xl  mt-8 font-bold'>Most recomanded book</h1>
